...
static {
     ...
     */
    [CRepr]
    public struct CXTargetInfo : int {};

    /**
     * A single translation unit, which resides in an index.
     */
    [CRepr]
    public struct CXTranslationUnit : int {};
    /**
	...
	[CLink]
	public static extern void clang_getExpansionLocation(CXSourceLocation location, CXFile* file, uint32* line, uint32* column, uint32* offset);

	[CLink]
	public static extern CXString clang_getFileName(CXFile file);
	...
	[CLink]
	public static extern void clang_disposeDiagnostic(CXDiagnostic diag);
     ...
     */
    [CLink]
    public static extern CXTranslationUnit clang_parseTranslationUnit(CXIndex CIdx, c_char * source_filename, c_char * *command_line_args, c_int num_command_line_args, CXUnsavedFile * unsaved_files, c_uint num_unsaved_files, CXTranslationUnit_Flags options);
	...
	[CLink]
	public static extern int32 clang_Location_isFromMainFile(CXSourceLocation location);
     ...
     */
	[CRepr]
    [AllowDuplicates] enum CXCallingConv : int32 {
	...
	[CRepr]
    public enum CXTemplateArgumentKind : int32 {
	...
	[CLink]
	public static extern char8* clang_getCString(CXString str);
     ...
     */
    [CLink]
    public static extern CXSourceRange clang_getCursorReferenceNameRange(CXCursor C, CXNameRefFlags NameFlags, c_uint PieceIndex);

	[CRepr]
    enum CXNameRefFlags : int32 {
        /**
